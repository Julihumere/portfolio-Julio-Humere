...
export default function About(props) {
  console.log("About", props.SobreMi);
  return (
    <motion.div
      className="box"
      initial={{ opacity: 0 }}
    ...
    >
      <div className={styles.About__container}>
        ...
        <div className={styles.About__text}>
          ...
          <div className={styles.About__buttons__cv}>
            <Link
              href={
            ...
            >
              <button className={styles.About__cv}>CV Español</button>
            </Link>
            <Link
              href={
            ...
            >
              <button className={styles.About__cv}>CV Ingles</button>
            </Link>
          </div>
        </div>
      </div>
